...
?>
  ...
  <div id="page-wrapper"><div><div>
    ...
    <div id="navigation"><div><div>
      ...
      <nav role="navigation" aria-label="Primary"><?php print render($page['navigation']); ?></nav>
      <div class="clear"></div>
    </div></div></div>
    <div class="clear"></div>
    <div role="banner" id="header"><div><div>
    ...
    <div id="main-wrapper"><div><div>
      ...
      <div role="main" id="content"><div><div>
        <a id="main-content"></a>
        <?php print render($title_prefix); ?>
        <?php if ($title): ?><div id="page-title"><div><div><div class="container"><h1 class="title"><?php print $title; ?></h1></div></div></div></div><?php endif; ?>
    ...
    <div role="complementary" aria-label="Widgets" id="widgets"><div><div>
    ...
    <div role="contentinfo" aria-label="Footer" id="footer"><div class="container"><div>
      ...
      <div id="footer-info">
        <div id="copyright"><span class="text-helv">&copy;</span> Digital Napkin <?php print date('Y'); ?></div>
