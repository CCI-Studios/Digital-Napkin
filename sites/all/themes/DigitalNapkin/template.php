...
function digitalnapkin_pager($variables) {
  $tags = $variables['tags'];
...
function digitalnapkin_menu_tree($variables) {
  return '<ul class="menu" aria-role="menu">' . $variables['tree'] . '</ul>';
}

function digitalnapkin_menu_link(array $variables) {
  $element = $variables['element'];
  $sub_menu = '';
...
function digitalnapkin_item_list($variables) {
